        ...
        <nav className="px-6 py-4 bg-[#091225]">
            ...
            <SheetContent side="right" className="w-[300px] bg-[#091225] border-l border-[#1B486A] p-6">
                ...
                <div className="mt-6 flex flex-col">
                    ...
                    <Link href="/login" className="px-4 py-2 text-[#6D758F] bg-white rounded-md hidden lg:flex">Login</Link>
                    <Link href="/signup" className="px-4 py-2 bg-[#1B486A] text-white rounded-md hidden lg:flex">
                        Sign up
                    </Link>
                </div>
            </div>
